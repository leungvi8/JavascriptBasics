...
//SOURCE -- https://classroom.udacity.com/courses/ud804/lessons/3412099388/concepts/34548187750923
...
function ruleList(results) {
    // Your code goes here!
    results = [];
    results.push(psinsights.formattedResults.ruleResults.AvoidBadRequests.localizedRuleName);
    results.push(psinsights.formattedResults.ruleResults.SpriteImages.localizedRuleName);
    results.push(psinsights.formattedResults.ruleResults.MinifyJavaScript.localizedRuleName);
...
function totalBytes(results) {
    ...
    results =
    parseInt(psinsights.pageStats.totalRequestBytes) + //used parseInt instead of Number() - parses a string and returns an integer.
    parseInt(psinsights.pageStats.htmlResponseBytes) +
